...
<header id="header" class="header header-style-1">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="nav-section header-sticky" style="width: 1496px;">
                <div class="primary-nav-section">
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                            ...
                            <li class="menu-item">
                                <a href="shop.html" class="link-term mercado-item-title">About Us</a>
                            </li>
                            <li class="menu-item">
                                <a href="cart.html" class="link-term mercado-item-title">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
