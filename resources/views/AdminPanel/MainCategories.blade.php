        ...
        <div class="page-content">
            <div class="row">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Main Category</h6>
                                ...
                                <table id="dataTableExample" class="table">
                                    ...
                                    <tr id="category{{$Categories->id}}">
                                        ...
                                        <td class="btn-group">
                                            ...
                                            <a href="{{route('GetId',$Categories->category)}}" class="btn btn-primary" data-toggle="modal" data-target="#editcategory{{$Categories->id}}">
                                                Edit
                                            </a>
